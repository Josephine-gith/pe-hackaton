...
regression = scipy.stats.linregress(df['Negative affect'],df['Positive affect'])
print(df['Positive affect'].isnan().sum())
plt.plot(x,regression[0]*x+regression[1], color='r')
